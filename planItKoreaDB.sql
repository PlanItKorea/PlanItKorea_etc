...
CREATE TABLE Product_Images (
    ...
    FOREIGN KEY (product_id) REFERENCES Products(id) ON DELETE CASCADE
>>>>>>> 9da2354d1eac91869b223668069957556080df28
);
...
order_id varchar(255) not null unique, # 주문 고유 id
payment_user_id varchar(255) not null, #유저 아이디
created_time varchar(255) not null, # 요청 일시
approved_time varchar(255) not null, # 승인 일시
payment_type varchar(255) not null # 결제 타입
);
